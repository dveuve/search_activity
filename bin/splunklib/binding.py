...
def _authentication(request_fun):
    ...
    *request_fun* is a function taking no arguments that needs to
    ...
    log in before isaing the request.
...
class Context(object):
    ...
    method before you can isae requests to splunkd. Or, use the :func:`connect`
    ...
    **Example**::
    ...
    def _auth_headers(self):
        ...
        Asames your ``Context`` already has a authentication token,
    ...
    def request(self, path_segment, method="GET", headers=None, body="",
        ...
        """Isaes an arbitrary HTTP request to the REST path segment.
    ...
    def login(self):
        ...
        you must call :meth:`login` before you can isae requests.
...
class HttpLib(object):
    ...
    def request(self, url, message, **kwargs):
        """Isaes an HTTP request to a URL.
