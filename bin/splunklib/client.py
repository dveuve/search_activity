...
class Service(_BaseService):
    ...
    method before you can isae requests to Splunk.
...
class Entity(Endpoint):
    ...
    def _run_action(self, path_segment, **kwargs):
        ...
        an Entity. _run_action asames that the returned XML is an
...
class ReadOnlyCollection(Endpoint):
    ...
    def _load_list(self, response):
        ...
        *response* is asamed to be a :class:`Record` containing an
